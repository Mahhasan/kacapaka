    ...
    public function update(Request $request, Category $category)
    {
        ...
        DB::transaction(function () use ($request, $category) {
            ...
            if ($oldPosition != $newPosition) {
                if ($oldPosition < $newPosition) {
                    Category::whereBetween('position', [$oldPosition + 1, $newPosition])->decrement('position');
                } else {
                    Category::whereBetween('position', [$newPosition, $oldPosition - 1])->increment('position');
                }
            }
